...
export default function ConsultationForm() {
  ...
  return (
    <section id="consultation" className="py-20 sm:py-28 bg-white relative border-t border-slate-200">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-white rounded-2xl p-6 sm:p-9 border border-slate-200 shadow-[0_4px_25px_rgba(15,23,42,0.04)] space-y-6"
          >
            <div>
            ...
            <div className="space-y-4 text-xs sm:text-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-slate-500 font-medium">Hotline & Zalo Kỹ Thuật:</div>
                  <a
                    href={`tel:${siteConfig.contact.phone}`}
                    className="font-serif font-bold text-base sm:text-lg text-slate-900 hover:text-blue-600 transition-colors"
                  >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-slate-500 font-medium">Hòm thư tiếp nhận brief:</div>
                  <a
                    href={`mailto:${siteConfig.contact.email}`}
                    className="font-medium text-xs sm:text-sm text-slate-900 hover:text-blue-600 transition-colors hover:underline"
                  >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-slate-500 font-medium">Cam kết bảo mật (NDA):</div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-slate-500 font-medium">Thời gian hỗ trợ:</div>
                  <span className="text-xs text-slate-600">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="lg:col-span-7 bg-white rounded-2xl p-6 sm:p-9 border border-slate-200 shadow-[0_4px_25px_rgba(15,23,42,0.04)]"
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs sm:text-sm bg-slate-50 border border-slate-200 text-slate-900 rounded-xl px-4 py-2.5 focus:bg-white focus:outline-hidden focus:border-blue-600 focus:ring-1 focus:ring-blue-600/30 transition-colors"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs sm:text-sm bg-slate-50 border border-slate-200 text-slate-900 rounded-xl px-4 py-2.5 focus:bg-white focus:outline-hidden focus:border-blue-600 focus:ring-1 focus:ring-blue-600/30 transition-colors cursor-pointer"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full text-xs sm:text-sm bg-slate-50 border border-slate-200 text-slate-900 rounded-xl px-4 py-2.5 focus:bg-white focus:outline-hidden focus:border-blue-600 focus:ring-1 focus:ring-blue-600/30 transition-colors resize-none"
                  />
                </div>
